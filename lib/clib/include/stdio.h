...
{ unsigned char *__ptr;
  ...
  long __clib_unused;    /* used to contain 32-bit file pointer */
...
FILE *fopen(const char * /*filename*/,
            const char * /*mode*/);
#if __STDC_VERSION__ >= 199901
FILE *_fopen64(const char * /*filename*/,
               const char * /*mode*/);
#if _FILE_OFFSET_BITS == 64
...
FILE *freopen(const char * /*filename*/,
              ...
              FILE * /*stream*/);
#if __STDC_VERSION__ >= 199901
FILE *_freopen64(const char * /*filename*/,
                 const char * /*mode*/,
                 FILE * /*stream*/);
#if _FILE_OFFSET_BITS == 64
...
int fgetpos(FILE * /*stream*/, _off_t * /*pos*/);
#if __STDC_VERSION__ >= 199901
int _fgetpos64(FILE * /*stream*/, _off64_t * /*pos*/);
#if _FILE_OFFSET_BITS == 64
