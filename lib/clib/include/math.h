...
#ifdef __CC_NORCROFT
/* In addition to the C++ comments below (which refer to CFront),
   __caller_narrow isn't implemented in ARM's Norcroft. */
#define __caller_narrow
#endif
...
#ifdef __CC_NORCROFT
// Should match with the #define at the top.
#undef __caller_narrow
#endif
